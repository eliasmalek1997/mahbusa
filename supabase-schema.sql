-- Run this in your Supabase SQL editor to set up the Mahbusa schema.
...
-- Allow anyone to read and write games (no auth required for MVP)
...
-- Go to Supabase dashboard → Database → Replication and enable "games" table,
-- or run:
